...
# 게임 종료 메시지 / Time Over(시간 초과 실패), Mission Complete(성공), Game Over(캐릭터가 공에 맞음)
...
while running:
    ...
    for event in pygame.event.get(): 
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_LEFT:
                ...
                charachter_to_x_RIGHT += character_speed
    ...
    # 3. 게임 캐릭터 위치 정의
    character_pos_x += (character_to_x_LEFT + charachter_to_x_RIGHT)
